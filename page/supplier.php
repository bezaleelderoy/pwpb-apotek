...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <a href="input.php?data=supplier" class="btn btn-primary mb-2">Insert data</a>
        <!-- ============================================================== -->
        <!-- Start Page Content -->
        <!-- ============================================================== -->
        <!-- Row -->
                            ...
                            <table class="table user-table no-wrap">
                                ...
                                <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($query)) {
                                        ...
                                        echo "<td><a href='edit.php?id=" . $data['id_supplier'] . "&data=supplier' type='button' class='btn btn-warning'><i class='bi bi-pencil-square'></i></a></td>";
                                                 ...
                                                 <div class='modal-dialog'>
                                                     <div class='modal-content'>
                                                         ...
                                                         <div class='modal-footer'>
                                                             <a href='delete.php?id=" . $data['id_supplier'] . "&data=supplier' class='btn btn-danger text-light'>HAPUS</a>
