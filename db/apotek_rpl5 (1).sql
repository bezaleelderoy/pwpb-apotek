...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2024 at 03:09 AM
...
(3827, 7, 4, 2, 13000, 26000),
(3828, 8, 5, 2, 7000, 14000),
(3829, 9, 5, 2, 7000, 14000),
(3830, 11, 5, 2, 7000, 14000),
(3831, 14, 5, 3, 7000, 21000),
(3832, 14, 2, 1, 3200, 3200),
(3833, 14, 2, 1, 3200, 3200),
(3834, 14, 2, 1, 3200, 3200),
(3835, 14, 2, 1, 3200, 3200),
(3836, 14, 2, 1, 3200, 3200),
(3837, 14, 2, 1, 3200, 3200),
(3838, 15, 5, 1, 7000, 7000),
(3839, 16, 3, 1, 5500, 5500),
(3840, 17, 3, 1, 5500, 5500);
...
(6, 1, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(7, 3, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(8, 5, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(9, 2, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(10, 1, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(11, 17, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(12, 17, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(13, 2, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(14, 5, 3, '2024-10-07', 'Normal', NULL, NULL, NULL),
(15, 4, 3, '2024-10-07', 'Normal', 7000, 10000, 3000),
(16, 3, 3, '2024-10-07', 'Normal', 5500, 6000, 500),
(17, 4, 3, '2024-10-07', 'Normal', 5500, 10000, 4500);
...
--
ALTER TABLE `tb_detail_transaksi`
  MODIFY `iddetailtransaksi` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3841;
...
--
ALTER TABLE `tb_transaksi`
  MODIFY `idtransaksi` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
